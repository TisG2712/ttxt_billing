$(document).ready(function () {
    ...
    $(".btn-editInFor").click(function () {
        let idPartner = $(this).attr("data-idPart");
        customGetPage(`${localdomain}/partners/editPartner?id=${idPartner}`, "#content_box")
    })
        ...
        if (checkValidate && checkEmpty){
            fetch(`${localdomain}/admin_service/partner/checkPassword`,{
                ...
                if(data.success){
                    ...
                    customGetPage(`/partners/infoUser?id=${idPart}&startDate=${getFirstDayOfMonth()}&endDate=${getLastDayOfMonth()}`, "#content_box");
                }else {
                    alert("Cập nhật mật khẩu thất bại.");
                    customGetPage(`/partners/infoUser?id=${idPart}&startDate=${getFirstDayOfMonth()}&endDate=${getLastDayOfMonth()}`, "#content_box");
                }
            }).catch(err => {
                console.log(err)
    ...
    $(".btn-removeService").click(function (){
        ...
        fetch(`${localdomain}/admin_service/partner/removeCateOfPassword?idPart=${idPart}&idCate=${idCate}`,{
            ...
            if(data.success){
                ...
                customGetPage(`${localdomain}/partners/infoUser?id=${idPart}&startDate=${getFirstDayOfMonth()}&endDate=${getLastDayOfMonth()}`, "#content_box");
            }else {
