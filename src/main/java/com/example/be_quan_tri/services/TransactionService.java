...
public class TransactionService {
    ...
    public Page<TransactionsPageDtos> getTransactionsPaginated(Long partnerId, String partnerCode, String status, LocalDateTime start, LocalDateTime end, Pageable pageable) {
