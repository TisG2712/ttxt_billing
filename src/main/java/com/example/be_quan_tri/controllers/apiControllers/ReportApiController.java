...
public class ReportApiController {
    ...
    public ResponseEntity<GloableReportResponse> exportDataListPartnerReport(
        ...
        return reportService.exportDataListPartnerReport(httpServletResponse, idPartner, localDateTimeStart, localDateTimeEnd, GloableValue.pageAndId("100", "0"));
    }
    ...
    public void exportDataListCategory(
        ...
        LocalDateTime localDateTimeEnd = LocalDateTime.parse(endDate);
        reportService.exportDataListCategory(partnerId, httpServletResponse, localDateTimeStart, localDateTimeEnd, GloableValue.pageAndId("100", "0"));
    }
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'PARTNER')")
    @GetMapping("exportDataPartnerGroup")
    public void exportDataPartnerGroup(
            HttpServletResponse httpServletResponse,
            @RequestParam("startDate") String startDate,
            @RequestParam("endDate") String endDate, @RequestParam("id") String id) throws IOException {
        Long idGroup = !Objects.equals(id, "") ? Long.valueOf(id) : null;
        LocalDateTime localDateTimeStart = LocalDateTime.parse(startDate);
        LocalDateTime localDateTimeEnd = LocalDateTime.parse(endDate);
        reportService.exportDataPartnerGroup(httpServletResponse,localDateTimeStart, localDateTimeEnd, idGroup);
    }
